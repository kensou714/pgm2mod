...
typedef struct ROLE_RAM ROLE_RAM;
typedef struct ROLE_CMD ROLE_CMD;
typedef struct ROLE_ROM ROLE_ROM;
...
struct ROLE_CMD
{
  ...
  __int16 Off_76;
  __int16 Off_78;
  ROLE_ROM *pRoleInfoROM_1;
  ROLE_ROM *pRoleInfoROM_2;
  int pImageTbl;
  __int16 Off_92;
  __int16 Off_94;
  int pWeaponPalPtr;
...
struct ROLE_ROM
{
  ...
  __int16 Off_7E;
  int pWeaponImageTbl;
  int pWeaponImageAxisTbl;
  int pWeaponLayerAttr;
};
